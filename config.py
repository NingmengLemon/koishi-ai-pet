...
_KEY_META = {
    ...
    "LLM_MAX_TOKENS_INTERACT":    {"type": "int",      "default": 600,           "category": "connection", "needs_restart": False, "hidden": False, "description": "交互模式LLM最大生成token数"},
    "LLM_MAX_TOKENS_CHAT":        {"type": "int",      "default": 1500,          "category": "connection", "needs_restart": False, "hidden": False, "description": "聊天模式LLM最大生成token数"},
    "LLM_MAX_TOKENS_AUTONOMOUS":  {"type": "int",      "default": 2500,          "category": "connection", "needs_restart": False, "hidden": False, "description": "自主模式LLM最大生成token数"},
    ...
    "VISION_SCALE":              {"type": "float",    "default": 0.75,          "category": "appearance", "needs_restart": False, "hidden": False, "description": "截图缩放比例(0.1~1.0)"},
