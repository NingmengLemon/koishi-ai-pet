...
_KEY_META = {
    ...
    "SKILLS_ENABLED":            {"type": "str_list", "default": ["system_monitor", "browser", "file", "weather", "web_search"], "category": "appearance", "needs_restart": True,  "hidden": False, "description": "启用的技能插件(逗号分隔, *=全部)"},
