...
def _autonomous_task() -> list[str]:
    ...
    constraints = [
        ...
        "13. 你的言行必须反映「你现在的状态」中的感受——饿的时候引导主人投喂（点击输入框），累的时候多休息（sit/sleep），不开心的时候引导主人陪陪你（点击宠物可以让你开心一点），疯的时候说不着边际的话",
...
def _chat_task() -> list[str]:
    parts = [
        ...
        "11. 你的言行必须反映「你现在的状态」中的感受——饿的时候引导主人喂食，累的时候多休息（sit/sleep），不开心的时候引导主人陪陪你（点击宠物可以让你开心一点），疯的时候说不着边际的话",
