...
_KEY_META = {
    ...
    "LLM_URL": {
        ...
        "needs_restart": False,
        "hidden": False,
        "description": "API 地址(需兼容 OpenAI 格式)",
    },
    "OLLAMA_BASE_URL": {
        "type": "str",
    ...
    "LLM_CACHE_PROMPT": {
        ...
        "needs_restart": False,
        "hidden": False,
        "description": "启用 Prompt 缓存",
    },
    "LLM_MAX_TOKENS_INTERACT": {
        "type": "int",
        "default": 800,
        "category": "connection",
        "needs_restart": False,
        "hidden": False,
        "description": "交互模式LLM输出Token上限",
    },
    "LLM_MAX_TOKENS_CHAT": {
        "type": "int",
        "default": 1500,
        ...
        "needs_restart": False,
        "hidden": False,
        "description": "聊天模式LLM输出Token上限",
    },
    "LLM_MAX_TOKENS_AUTONOMOUS": {
        "type": "int",
        "default": 2500,
        "category": "connection",
        "needs_restart": False,
        "hidden": False,
        "description": "自主模式LLM输出Token上限",
    },
    "LLM_TEMPERATURE": {
        "type": "float",
        "default": 0.7,
    ...
    "LLM_TOOL_MAX_ROUNDS": {
        ...
        "needs_restart": False,
        "hidden": False,
        "description": "工具调用最大轮次",
    },
    "LLM_ACTION_MIN_DIVISOR": {
        "type": "int",
        "default": 25,
        "category": "connection",
        "needs_restart": False,
        "hidden": True,
        "description": "动作权重最小除数",
    },
    # ── Behavior ──
    "SCHEDULER_FAST_MS": {
        "type": "int",
    ...
    "SCHEDULER_SLOW_MS": {
        ...
        "needs_restart": False,
        "hidden": True,
        "description": "slow_tick 间隔(毫秒)",
    },
    "SCHEDULER_AUTO_START_FAST": {
        "type": "bool",
        "default": True,
        "category": "behavior",
        "needs_restart": False,
        "hidden": True,
        "description": "自动启动 fast_tick",
    },
    "SCHEDULER_AUTO_START_MID": {
        "type": "bool",
        "default": True,
        "category": "behavior",
        "needs_restart": False,
        "hidden": False,
        "description": "自动启动 mid_tick(自主决策)",
    },
    ...
    "ACTION_TIMEOUT_MS": {
        ...
        "needs_restart": False,
        "hidden": True,
        "description": "单个动作超时(毫秒)",
    },
    "SANITY_CRITICAL_THRESHOLD": {
        "type": "int",
        "default": 20,
        "category": "behavior",
        "needs_restart": False,
        "hidden": False,
        "description": "理智临界值，低于该值导致异常行为",
    },
    "INTERACT_GRABBED_PROMPT": {
        "type": "str",
        "default": "",
        "category": "behavior",
        "needs_restart": False,
        "hidden": False,
        "description": "被抓取时的自定义回复 prompt",
    },
    "INTERACT_RELEASED_PROMPT": {
        "type": "str",
        "default": "",
        "category": "behavior",
        "needs_restart": False,
        "hidden": False,
        "description": "被放下时的自定义回复 prompt",
    },
    "INTERACT_WINDOW_DISAPPEARED_PROMPT": {
        "type": "str",
        "default": "",
        "category": "behavior",
        "needs_restart": False,
        "hidden": False,
        "description": "窗口消失时的自定义回复 prompt",
    },
    "INTERACT_FED_PROMPT": {
        "type": "str",
        "default": "",
        ...
        "needs_restart": False,
        "hidden": True,
        "description": "喂食交互的自定义 prompt 模板",
    },
    # ── Appearance ──
    "VISION_ENABLED": {
        "type": "bool",
    ...
    "PET_PERSONALITY": {
        ...
        "needs_restart": False,
        "hidden": False,
        "description": "宠物人格描述(注入 system prompt)",
    },
    # ── Voice Input ──
    "XF_APPID": {
        "type": "str",
    ...
    "EMBEDDING_URL": {
        ...
        "needs_restart": True,
        "hidden": False,
        "description": "Embedding API 地址(需兼容 OpenAI 格式)",
    ...
    "MEMORY_RECALL_COOLDOWN_S": {
        "type": "int",
        "default": 300,
        "category": "memory",
        "needs_restart": False,
        "hidden": True,
        "description": "记忆召回冷却时间(秒)",
    },
    "MEMORY_L3_EXPIRE_DAYS": {
        "type": "int",
        "default": 3,
        "category": "memory",
        "needs_restart": False,
        "hidden": False,
        "description": "L3临时记忆过期天数",
    },
    "MEMORY_RERANK_WEIGHT_SIM": {
        "type": "float",
        "default": 0.7,
        "category": "memory",
        "needs_restart": False,
        "hidden": True,
        "description": "重排序-语义相似度权重",
    },
    "MEMORY_RERANK_WEIGHT_IMP": {
        "type": "float",
        "default": 0.2,
        "category": "memory",
        "needs_restart": False,
        "hidden": True,
        "description": "重排序-有效重要性权重",
    },
    ...
    "CONTEXT_MAX_ENTRIES": {
        ...
        "needs_restart": False,
        "hidden": False,
        "description": "上下文最大条目数",
    },
    "CONTEXT_HISTORY_ENTRIES": {
        "type": "int",
        "default": 8,
        "category": "behavior",
        "needs_restart": False,
        "hidden": False,
        "description": "上下文历史条目数",
    },
    "CONTEXT_MAX_SUMMARIES": {
        "type": "int",
        "default": 5,
        "category": "behavior",
        "needs_restart": False,
        "hidden": True,
        "description": "上下文最大摘要数",
    },
    "CONTEXT_HALF_LIFE_S": {
        "type": "int",
        "default": 1800,
